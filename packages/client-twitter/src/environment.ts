...
export const twitterEnvSchema = z.object({
    ...
    TWITTER_POLL_INTERVAL_MIN: z.number().int(),
    TWITTER_POLL_INTERVAL_MAX: z.number().int(),
...
export async function validateTwitterConfig(
    ...
    try {
        const twitterConfig = {
            ...
            // int in seconds
            TWITTER_POLL_INTERVAL_MIN: safeParseInt(
                runtime.getSetting("TWITTER_POLL_INTERVAL_MIN") ||
                    process.env.TWITTER_POLL_INTERVAL_MIN,
                80
            ), // 1m20s
            // int in seconds
            TWITTER_POLL_INTERVAL_MAX: safeParseInt(
                runtime.getSetting("TWITTER_POLL_INTERVAL_MAX") ||
                    process.env.TWITTER_POLL_INTERVAL_MAX,
                200
            ), // 3m20s
            ...
            ACTION_INTERVAL_MIN: safeParseInt(
                runtime.getSetting("ACTION_INTERVAL_MIN") ||
                    process.env.ACTION_INTERVAL_MIN,
                3
            ), // 3 minutes
            ACTION_INTERVAL_MAX: safeParseInt(
                runtime.getSetting("ACTION_INTERVAL_MAX") ||
                    process.env.ACTION_INTERVAL_MAX,
                5
            ), // 10 minutes
            // bool
            POST_IMMEDIATELY:
